  ...
  const menuSections = [
    {
      ...
      items: [
        ...
        { name: '히로인 갤러리', icon: '💕', path: '/heroines', color: 'from-pink-500 to-pink-600' }
      ]
    },
    {
      title: '🏆 진행도 & 컬렉션',
    ...
    },
    {
      title: '⚔️ 커뮤니티 & 협동',
      items: [
        { name: '동아리', icon: '🎭', path: '/clubs', color: 'from-purple-500 to-indigo-600' },
        ...
        <div className="bg-black/30 backdrop-blur rounded-xl p-6 mt-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="bg-white/10 rounded-lg p-4">
              ...
              <div className="text-2xl font-bold text-green-400">{player.money || 0} G</div>
            </div>
            <div className="bg-white/10 rounded-lg p-4">
